...
let TWSecondaryTextColor = UIColor.grayColor()
...
let TWTweetFont = UIFont(name: "HelveticaNeue", size: 17)
let TWTweetFontLarge = UIFont(name: "HelveticaNeue-Light", size: 20)
